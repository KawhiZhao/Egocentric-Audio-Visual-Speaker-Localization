...
import pdb
from model import MInterface, MInterfaceWearer
...
if __name__ == '__main__':
    ...
    # Training Info
    parser.add_argument('--dataset', default='easy_com', type=str)
    parser.add_argument('--data_dir', default='ref/data', type=str)
  
    parser.add_argument('--model_name', default='audio_visual_transformer_attention', type=str)
    ...
    parser.add_argument('--weight_ce', default=True, type=bool)
