...
class DInterfaceAVST(pl.LightningDataModule):
    ...
    def __init__(self, num_workers=8,
        ...
        # self.reshape_feature = kwargs['reshape_feature']
    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit' or stage is None or stage == 'validate':
            self.trainset = self.instancialize(path_file="paths_list_full_train.npy",
                                                prefix='', 
                                                model='transformer', 
                                                image_width=1920, 
                                                image_height=1080, 
                                                ...
                                                bbox=True, 
                                                rescale_index=0)
            self.valset = self.instancialize(path_file="paths_list_full_eval.npy",
                                                prefix='', 
                                                model='transformer', 
                                                image_width=1920, 
                                                image_height=1080, 
        ...
        if stage == 'test' or stage is None:
            self.testset = self.instancialize(path_file="paths_test.npy",
                                                prefix='', 
                                                model='transformer', 
                                                image_width=1920, 
                                                image_height=1080, 
